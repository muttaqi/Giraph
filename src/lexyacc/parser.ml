...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 12 "src/lexyacc/definitions/parser.mly"
                            ( _1 )
# 93 "src/lexyacc/parser.ml"
               : int))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : int) in
    Obj.repr(
# 15 "src/lexyacc/definitions/parser.mly"
                            ( _1 )
# 100 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'expr) in
    Obj.repr(
# 16 "src/lexyacc/definitions/parser.mly"
                              ( _2 )
# 107 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 17 "src/lexyacc/definitions/parser.mly"
                              ( _1 + _3 )
# 115 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 18 "src/lexyacc/definitions/parser.mly"
                              ( _1 - _3 )
# 123 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 19 "src/lexyacc/definitions/parser.mly"
                              ( _1 * _3 )
# 131 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 20 "src/lexyacc/definitions/parser.mly"
                              ( _1 / _3 )
# 139 "src/lexyacc/parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'expr) in
    Obj.repr(
# 21 "src/lexyacc/definitions/parser.mly"
                              ( - _2 )
# 146 "src/lexyacc/parser.ml"
               : 'expr))
(* Entry main *)
